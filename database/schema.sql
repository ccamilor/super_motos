-- ============================================================================
-- MotoRuta Pro — Schema completo para Supabase
-- ============================================================================
-- Instrucciones:
--   1. Creá un proyecto nuevo en https://supabase.com
--   2. Andá a SQL Editor en el panel izquierdo
--   3. Pegá este archivo entero y ejecutalo (botón "Run" o Ctrl+Enter)
--   4. Creá los usuarios desde Authentication > Users
...
CREATE TABLE IF NOT EXISTS inventario_camion (
    ...
    numero_canasta  INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS facturas (
    ...
    vendedor_id     BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS detalles_factura (
    id              BIGSERIAL PRIMARY KEY,
    factura_numero  BIGINT NOT NULL REFERENCES facturas(numero_factura) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS devoluciones (
    ...
    cantidad                INTEGER NOT NULL DEFAULT 0,
    numero_canasta_destino  TEXT NOT NULL DEFAULT '',
...
CREATE INDEX IF NOT EXISTS idx_detalles_factura_factura ON detalles_factura(factura_numero);
...
-- ============================================================================
-- ATENCION: Esto permite que cualquiera con la anon key lea/escriba todas
-- las tablas. Para produccion, restringi estas politicas a usuarios autenticados.
-- ============================================================================
...
-- Politicas: permitir todo a anon y authenticated
...
-- Politicas: permitir todo a usuarios autenticados (por si a futuro se migra)
...
-- Deberias ver las 9 tablas: productos, inventario_camion, inventario_bodega,
--   clientes, facturas, detalles_factura, devoluciones, proveedores, historial_precios
-- ============================================================================
